...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "MotorFL";
    public static String leftRearMotorName = "MotorBL";
    public static String rightFrontMotorName = "MotorFR";
    public static String rightRearMotorName = "MotorBR";

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 59.4875;
    private static double yMovement = 48.6782;
    ...
    public static double mass = 9.616;
    ...
    public static double forwardZeroPowerAcceleration = -39.5871;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -63.7398;
